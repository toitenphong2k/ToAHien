<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ListFilesFES.aspx.cs" Inherits="ListFilesFES" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="aParent" >
        <div style="width: 45%">
             ...
             <uc1:FileGridVB ID="FileGridVB1" HomeFolder="\\192.168.128.5\" runat="server" PageSize="10" />
        </div>
        <div style="width: 55%">
