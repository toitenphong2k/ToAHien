<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ListFilesCSFE.aspx.cs" Inherits="ListFilesCSFE" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="aParent" >
 	...
 	<uc1:FileGridVB ID="FileGridVB1" HomeFolder="~/ContentFE" runat="server" PageSize="10" />
           <%-- <uc1:FileGridVB ID="FileGridVB1" HomeFolder="~/ContentFE" runat="server" PageSize="10" />--%>
           <%-- <uc1:FileGridVB ID="FileGridVB1" HomeFolder="\\192.168.128.5\vpa1" runat="server" PageSize="10" />--%>
        ...
        <div style="width: 55%">
            <table runat="server" id="tblChat" style="width: 100%">
                ...
                <tr>
                    ...
                    <td>
                        <asp:FileUpload CssClass="ddl" ID="FileUpload2" runat="server" Height="30px" Width="398px" />
                    </td>
                    <td>
