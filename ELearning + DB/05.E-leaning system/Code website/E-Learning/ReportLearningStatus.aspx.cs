...
{
    public partial class ReportLearningStatus : System.Web.UI.Page
    {
        ...
        {
            dtReportCourse = DBConnect.FillStore("S_Report_Traing_Learning_Status", CommandType.StoredProcedure);
        }
        ...
        public void BindSearch(string CourseID )
        {
            ...
            dtReportCourse = DBConnect.FillStore("S_Report_Traing_Learning_Status_Search", CommandType.StoredProcedure, CourseID);
        }
        ...
        protected void bttPrintPDF_ServerClick(object sender, EventArgs e)
        {
            ...
            dtSerch = DBConnect.StoreFillDS("S_Report_Traing_Learning_Status_Search", System.Data.CommandType.StoredProcedure, Course);
            ...
            if (dtSerch.Rows.Count >= 0)
            {
                ...
                {
                    sr += "<tr style =\"padding:25px;height:40px;font-size:15px;text-align: center;\">";
                    for (int i = 0; i < dtSerch.Columns.Count; i++)
                    {
                        if (i == 0 || i == 1 || i == 3 || i == 6 || i == 5 || i == 7)
                        {
                ...
                //context.Response.AddHeader("Content-Disposition", "attachment; filename= Traing_Learning_Status.xls");
                //context.Response.ContentEncoding = System.Text.Encoding.GetEncoding("System.Text.Encoding.Unicode");
