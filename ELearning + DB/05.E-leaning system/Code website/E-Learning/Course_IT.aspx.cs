...
{
    public partial class Course_IT : System.Web.UI.Page
    {
        ...
        {
            dtAllCourse_Join = DBConnect.FillStore("SP_Training_ListCourse_QLIT_Join", CommandType.StoredProcedure, UserTraining);
        }

        public void All_Course_NotJoin(string UserTraining)

        {
            dtCourse_NotJoin = DBConnect.FillStore("SP_Training_ListCourse_QLIT_NotJoin", CommandType.StoredProcedure, UserTraining);
        }
        public void All_Course_Finish(string UserTraining)

        {
            dtAllCourse_Finish = DBConnect.FillStore("SP_Training_ListCourse_QLIT_Finish", CommandType.StoredProcedure, UserTraining);
        }
