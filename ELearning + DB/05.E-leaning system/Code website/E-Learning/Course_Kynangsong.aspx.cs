...
{
    public partial class Course_Kynangsong : System.Web.UI.Page
    {
        ...
        {
            dtAllCourse_Join = DBConnect.FillStore("SP_Training_ListCourse_QLSONG_MustLearning", CommandType.StoredProcedure, UserTraining);
        }

        public void All_Course_NotJoin(string UserTraining)

        {
            dtCourse_NotJoin = DBConnect.FillStore("SP_Training_ListCourse_QLSONG_NotJoin", CommandType.StoredProcedure, UserTraining);
        }
        public void All_Course_Finish(string UserTraining)

        {
            dtAllCourse_Finish = DBConnect.FillStore("SP_Training_ListCourse_QLSONG_Finish", CommandType.StoredProcedure, UserTraining);
        }
