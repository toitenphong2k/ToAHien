                                  ...
                                  <div class="left">
                                    <ul class="main-menu__list">
                                        ...
                                        <li class="dropdown">
                                            <a href="#">Courses</a>
                                            <ul>
                                                <li><a href="ListCourse.aspx">Courses</a></li>
                                            </ul>
                                        </li>
                                       <%--  <li class="dropdown">
                                            <a href="#">The Exam</a>
                                            <ul>
                                                <li><a href="ListCourse.aspx">Mini exam </a></li>
                                                <li><a href="ListCourse.aspx">Exam</a></li>
                                            </ul>
                                        </li>--%>
                                        <li class="dropdown">
                                                ...
                                                <ul>
                                                    <li>
                                                        <a href="ControlClassEmployee.aspx">Control User Training</a>
                                                    </li>
                                                    <li>
                                                        <a href="ControlCourse.aspx">Control Course</a>
                                                    </li>
                                                    <li>
                                                        <a href="ControlClass.aspx">Control Class</a>
                                                    </li>
                                                    <li>
                                                        <a href="ControlQuestionAnser.aspx">Control Question Anser</a>
                                                    </li>
                                                    <li>
                                                        <a href="ControlLesson.aspx">Control Lesson</a>
                                                    </li>

                                                </ul>
                                            </li>
                                         <li class="dropdown">
                                            <asp:LinkButton ID ="lbkLogout" runat ="server"  OnClick ="lbkLogout_Click" Text ="LogOut"> </asp:LinkButton>
                                        </li>
                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="container">
                            <div class="main-slider__content">
                                ...
                                <h2 class="main-slider__content-title">WE CAN <br>TEACH YOU</h2>
                                <p class="main-slider__content-text">
                    ...
                    <div class="col-xl-6">
                        <div class="about-one__left">
                            ...
                            <div class="about-one__left-overlay">
                                ...
                                <div class="title">
                                    <h6>Trusted by<br><span class="odometer" data-count="8800">00</span> trainees</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-6">
                        <div class="about-one__right">
                            <div class="section-title">
                                <span class="section-title__tagline">About PSNV E-learning System</span>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6">
                        <div class="courses-one__single wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1000ms">
                            ...
                            <div class="courses-one__single-content">
                                ...
                                <h6 class="courses-one__single-content-name">PVG </h6>
                                <h4 class="courses-one__single-content-title"><a href="Detail_Course.aspx">Orientation Training</a></h4>
                        ...
                        <div class="registration-one__left">
                            <div class="section-title">
                                ...
                                <h2 class="section-title__title">
                                    Register your Account<br> Get free Access to <span class="odometer" data-count="66000">00</span> <br>Online Courses
                                </h2>
                            </div>
                            ...
                            <div class="registration-one__left-transform-box">
                                ...
                                <div class="registration-one__left-transform-box-text">
                                    ...
                                    <p>
                                        Discover creative projects limited editions of 100 <br>from artists, designers,
                                        and more.
                                    </p>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-12">
                        <div class="testimonials-one__wrapper">
                            <div class="testimonials-one__pattern">
                                <img src="assets/images/pattern/testimonials-one-left-pattern.png" alt="" />
                            </div>
                        ...
                        <div class="blog-one__single">
                            ...
                            <div class="blog-one__single-content">
                                ...
                                <p class="blog-one__single-content-text">
                                    Lorem ipsum is simply free text on used by
                                    copytyping refreshing the whole area.
                                </p>
                            </div>
                        </div>
                    </div>
...
--%>
    ...
    <script src="js/Java_LoadImage.js"></script>
