<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Detail_Course.aspx.cs" Inherits="E_Learning.Detail_Course" %>
                    ...
                    <div class="course-details__sidebar-meta wow fadeInUp animated" data-wow-delay="0.3s">
                        <ul class="course-details__sidebar-meta-list list-unstyled">
                            <li class="course-details__sidebar-meta-list-item">
                                ...
                                <div class="text">
                                    <p><a href="#">Status Course:<span><asp:Label ID  ="lblStatusCourse" runat ="server"></asp:Label></span></a></p>
                                </div>
                            </li>
                            ...
                            <li class="course-details__sidebar-meta-list-item">
                                ...
                                <div class="dropdown-menu" id="Tr_ID" runat ="server">
                                    <asp:Repeater ID="prtDetailLeasson" runat="server" OnItemDataBound ="prtDetailLeasson_ItemDataBound" >  <%--Bind repter de su dung duoc link OnItemDataBound ="prtDetailLeasson_ItemDataBound" --%>
                                        <ItemTemplate>
                            ...
                            <li class="course-details__sidebar-meta-list-item">
                                ...
                                <div class="text">
                                    <p>
                                        <a>
                                        <span>
                                        <asp:LinkButton ID ="lbkTest" runat ="server"   OnClick ="lbkTest_Click"  ForeColor ="Black" Text ="Test" OnClientClick="openInNewTab()" ></asp:LinkButton>
                                       </span>
                    ...
                    <div class="courses-one__single style2 wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1000ms">
                        ...
                        <div class="courses-one__single-content">
                            ...
                            <div class="course-details__content-text1">
                                <p>
                                    <b style="font-family:Tahoma; font-size:16px;"><asp:Label ID ="lblgioithieu" runat ="server"></asp:Label></b>
                                </p>
                            </div>
